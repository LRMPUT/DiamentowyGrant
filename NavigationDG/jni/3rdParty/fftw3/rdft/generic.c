...
static void cdot_r2hc(INT n, const E *x, const float *w, float *or0, float *oi1)
{
     INT i;
...
static void hartley_r2hc(INT n, const float *xr, INT xs, E *o, float *pr)
{
     INT i;
     E sr;
     o[0] = sr = xr[0]; o += 1;
...
static void cdot_hc2r(INT n, const E *x, const float *w, float *or0, float *or1)
{
     INT i;
...
static void hartley_hc2r(INT n, const float *x, INT xs, E *o, float *pr)
{
     INT i;
     E sr;
...
static plan *mkplan(const solver *ego_, const problem *p_, planner *plnr)
{
     ...
     static const plan_adt padt = {
	  fftwf_rdft_solve, awake, print, fftwf_plan_null_destroy
     };
