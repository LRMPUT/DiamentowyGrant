...
static const kr2c_desc desc = { 7, "r2cbIII_7", {2, 0, 22, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_7 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_7, &desc);
}
...
static const kr2c_desc desc = { 7, "r2cbIII_7", {9, 4, 15, 0}, &fftwf_rdft_r2cbIII_genus };
