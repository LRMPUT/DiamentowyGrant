...
static void hb_16(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 16, "hb_16", twinstr, &fftwf_rdft_hb_genus, {136, 46, 38, 0} };

void fftwf_codelet_hb_16(planner *p) {
     fftwf_khc2hc_register(p, hb_16, &desc);
}
#endif				/* HAVE_FMA */
