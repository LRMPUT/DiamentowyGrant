...
static void hc2cbdft_6(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 6, "hc2cbdft_6", twinstr, &fftwf_rdft_hc2cb_genus, {36, 10, 22, 0} };

void fftwf_codelet_hc2cbdft_6 (planner *p) {
     fftwf_khc2c_register (p, hc2cbdft_6, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 6, "hc2cbdft_6", twinstr, &fftwf_rdft_hc2cb_genus, {44, 14, 14, 0} };
