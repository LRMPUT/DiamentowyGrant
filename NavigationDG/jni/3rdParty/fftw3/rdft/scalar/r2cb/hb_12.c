...
static void hb_12(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 12, "hb_12", twinstr, &fftwf_rdft_hb_genus, {88, 30, 30, 0} };

void fftwf_codelet_hb_12(planner *p) {
     fftwf_khc2hc_register(p, hb_12, &desc);
}
#endif				/* HAVE_FMA */
