...
static void hb_2(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
void fftwf_codelet_hb_2 (planner *p) {
     fftwf_khc2hc_register (p, hb_2, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 2, "hb_2", twinstr, &fftwf_rdft_hb_genus, {4, 2, 2, 0} };
