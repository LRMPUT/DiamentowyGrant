...
static const hc2c_desc desc = { 16, "hc2cb_16", twinstr, &fftwf_rdft_hc2cb_genus, {104, 30, 70, 0} };

void fftwf_codelet_hc2cb_16 (planner *p) {
     fftwf_khc2c_register (p, hc2cb_16, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 16, "hc2cb_16", twinstr, &fftwf_rdft_hc2cb_genus, {136, 46, 38, 0} };
