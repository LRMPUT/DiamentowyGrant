...
static void r2cb_32(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 32, "r2cb_32", {72, 0, 84, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_32 (planner *p) {
     fftwf_kr2c_register (p, r2cb_32, &desc);
}
...
static const kr2c_desc desc = { 32, "r2cb_32", {140, 34, 16, 0}, &fftwf_rdft_r2cb_genus };
