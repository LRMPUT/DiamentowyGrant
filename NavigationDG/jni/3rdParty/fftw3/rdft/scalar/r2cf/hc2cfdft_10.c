...
static void hc2cfdft_10(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 10, "hc2cfdft_10", twinstr, &fftwf_rdft_hc2cf_genus, {68, 38, 54, 0} };

void fftwf_codelet_hc2cfdft_10 (planner *p) {
     fftwf_khc2c_register (p, hc2cfdft_10, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 10, "hc2cfdft_10", twinstr, &fftwf_rdft_hc2cf_genus, {92, 38, 30, 0} };
