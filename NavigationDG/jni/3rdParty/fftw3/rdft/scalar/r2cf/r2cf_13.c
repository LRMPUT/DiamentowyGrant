...
static void r2cf_13(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 13, "r2cf_13", {31, 6, 45, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_13 (planner *p) {
     fftwf_kr2c_register (p, r2cf_13, &desc);
}
...
static const kr2c_desc desc = { 13, "r2cf_13", {57, 15, 19, 0}, &fftwf_rdft_r2cf_genus };
