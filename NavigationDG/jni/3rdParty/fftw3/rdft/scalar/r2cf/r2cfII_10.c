...
static void r2cfII_10(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 10, "r2cfII_10", {14, 0, 18, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_10 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_10, &desc);
}
...
static const kr2c_desc desc = { 10, "r2cfII_10", {26, 6, 6, 0}, &fftwf_rdft_r2cfII_genus };
