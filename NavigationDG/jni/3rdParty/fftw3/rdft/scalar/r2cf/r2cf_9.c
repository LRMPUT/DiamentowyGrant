...
static void r2cf_9(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 9, "r2cf_9", {12, 4, 26, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_9 (planner *p) {
     fftwf_kr2c_register (p, r2cf_9, &desc);
}
...
static const kr2c_desc desc = { 9, "r2cf_9", {21, 9, 17, 0}, &fftwf_rdft_r2cf_genus };
