...
static void r2cfII_64(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 64, "r2cfII_64", {114, 0, 320, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_64 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_64, &desc);
}
...
static const kr2c_desc desc = { 64, "r2cfII_64", {342, 114, 92, 0}, &fftwf_rdft_r2cfII_genus };
