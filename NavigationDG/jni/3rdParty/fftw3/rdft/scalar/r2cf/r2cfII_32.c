...
static void r2cfII_32(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 32, "r2cfII_32", {46, 0, 128, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_32 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_32, &desc);
}
...
static const kr2c_desc desc = { 32, "r2cfII_32", {138, 46, 36, 0}, &fftwf_rdft_r2cfII_genus };
