...
static void hc2cfdft_20(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 20, "hc2cfdft_20", twinstr, &fftwf_rdft_hc2cf_genus, {176, 78, 110, 0} };

void fftwf_codelet_hc2cfdft_20 (planner *p) {
     fftwf_khc2c_register (p, hc2cfdft_20, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 20, "hc2cfdft_20", twinstr, &fftwf_rdft_hc2cf_genus, {224, 78, 62, 0} };
