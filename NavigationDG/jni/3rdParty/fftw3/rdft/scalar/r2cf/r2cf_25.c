...
static void r2cf_25(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 25, "r2cf_25", {44, 12, 156, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_25 (planner *p) {
     fftwf_kr2c_register (p, r2cf_25, &desc);
}
...
static const kr2c_desc desc = { 25, "r2cf_25", {117, 57, 83, 0}, &fftwf_rdft_r2cf_genus };
