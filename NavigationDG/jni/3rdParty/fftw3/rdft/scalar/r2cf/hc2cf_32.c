...
static void hc2cf_32(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 32, "hc2cf_32", twinstr, &fftwf_rdft_hc2cf_genus, {236, 62, 198, 0} };

void fftwf_codelet_hc2cf_32 (planner *p) {
     fftwf_khc2c_register (p, hc2cf_32, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 32, "hc2cf_32", twinstr, &fftwf_rdft_hc2cf_genus, {340, 114, 94, 0} };
