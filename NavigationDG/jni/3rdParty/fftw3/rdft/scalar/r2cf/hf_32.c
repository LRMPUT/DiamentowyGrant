...
static void hf_32(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 32, "hf_32", twinstr, &fftwf_rdft_hf_genus, {236, 62, 198, 0} };

void fftwf_codelet_hf_32 (planner *p) {
     fftwf_khc2hc_register (p, hf_32, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 32, "hf_32", twinstr, &fftwf_rdft_hf_genus, {340, 114, 94, 0} };
