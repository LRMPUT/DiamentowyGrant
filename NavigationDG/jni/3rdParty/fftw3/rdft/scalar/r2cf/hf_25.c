...
static void hf_25(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 25, "hf_25", twinstr, &fftwf_rdft_hf_genus, {84, 48, 316, 0} };

void fftwf_codelet_hf_25 (planner *p) {
     fftwf_khc2hc_register (p, hf_25, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 25, "hf_25", twinstr, &fftwf_rdft_hf_genus, {260, 140, 140, 0} };
