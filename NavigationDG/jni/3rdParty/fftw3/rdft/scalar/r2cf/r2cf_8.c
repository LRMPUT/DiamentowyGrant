...
static void r2cf_8(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 8, "r2cf_8", {16, 0, 4, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_8 (planner *p) {
     fftwf_kr2c_register (p, r2cf_8, &desc);
}
...
static const kr2c_desc desc = { 8, "r2cf_8", {20, 2, 0, 0}, &fftwf_rdft_r2cf_genus };
