...
static void hc2cf_2(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
static const hc2c_desc desc = { 2, "hc2cf_2", twinstr, &fftwf_rdft_hc2cf_genus, {4, 2, 2, 0} };

void fftwf_codelet_hc2cf_2 (planner *p) {
     fftwf_khc2c_register (p, hc2cf_2, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
