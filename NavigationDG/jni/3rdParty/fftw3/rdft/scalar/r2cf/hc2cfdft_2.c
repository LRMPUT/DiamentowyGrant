...
static void hc2cfdft_2(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 2, "hc2cfdft_2", twinstr, &fftwf_rdft_hc2cf_genus, {8, 6, 2, 0} };

void fftwf_codelet_hc2cfdft_2 (planner *p) {
     fftwf_khc2c_register (p, hc2cfdft_2, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */
