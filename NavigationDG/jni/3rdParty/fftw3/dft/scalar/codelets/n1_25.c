...
static void n1_25(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 25, "n1_25", {84, 0, 268, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_25 (planner *p) {
     fftwf_kdft_register (p, n1_25, &desc);
}
...
static const kdft_desc desc = { 25, "n1_25", {260, 92, 92, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
