...
static void t1_6(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 6, "t1_6", twinstr, &fftwf_dft_t_genus, {24, 10, 22, 0}, 0, 0, 0 };

void fftwf_codelet_t1_6 (planner *p) {
     fftwf_kdft_dit_register (p, t1_6, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 6, "t1_6", twinstr, &fftwf_dft_t_genus, {32, 14, 14, 0}, 0, 0, 0 };
