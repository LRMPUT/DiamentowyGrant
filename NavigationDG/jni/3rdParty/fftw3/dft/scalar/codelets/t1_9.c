...
static void t1_9(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 9, "t1_9", twinstr, &fftwf_dft_t_genus, {24, 16, 72, 0}, 0, 0, 0 };

void fftwf_codelet_t1_9 (planner *p) {
     fftwf_kdft_dit_register (p, t1_9, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 9, "t1_9", twinstr, &fftwf_dft_t_genus, {60, 36, 36, 0}, 0, 0, 0 };
