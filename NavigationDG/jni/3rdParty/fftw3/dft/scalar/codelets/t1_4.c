...
static void t1_4(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
static const ct_desc desc = { 4, "t1_4", twinstr, &fftwf_dft_t_genus, {16, 6, 6, 0}, 0, 0, 0 };

void fftwf_codelet_t1_4 (planner *p) {
     fftwf_kdft_dit_register (p, t1_4, &desc);
}
#else				/* HAVE_FMA */
