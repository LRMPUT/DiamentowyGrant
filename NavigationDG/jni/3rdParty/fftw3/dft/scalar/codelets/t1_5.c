...
static void t1_5(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 5, "t1_5", twinstr, &fftwf_dft_t_genus, {14, 8, 26, 0}, 0, 0, 0 };

void fftwf_codelet_t1_5 (planner *p) {
     fftwf_kdft_dit_register (p, t1_5, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 5, "t1_5", twinstr, &fftwf_dft_t_genus, {26, 14, 14, 0}, 0, 0, 0 };
