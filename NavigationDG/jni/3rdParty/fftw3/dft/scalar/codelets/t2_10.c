...
static void t2_10(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 10, "t2_10", twinstr, &fftwf_dft_t_genus, {48, 28, 66, 0}, 0, 0, 0 };

void fftwf_codelet_t2_10 (planner *p) {
     fftwf_kdft_dit_register (p, t2_10, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 10, "t2_10", twinstr, &fftwf_dft_t_genus, {76, 42, 38, 0}, 0, 0, 0 };
