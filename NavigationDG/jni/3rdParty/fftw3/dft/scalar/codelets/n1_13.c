...
static void n1_13(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 13, "n1_13", {62, 0, 114, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_13 (planner *p) {
     fftwf_kdft_register (p, n1_13, &desc);
}
...
static const kdft_desc desc = { 13, "n1_13", {138, 30, 38, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
