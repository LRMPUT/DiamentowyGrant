...
static void n1_4(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
     INT i;
...
static const kdft_desc desc = { 4, "n1_4", {16, 0, 0, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_4 (planner *p) {
     fftwf_kdft_register (p, n1_4, &desc);
}
