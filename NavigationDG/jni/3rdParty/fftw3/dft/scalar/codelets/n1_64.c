...
static void n1_64(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 64, "n1_64", {520, 0, 392, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_64 (planner *p) {
     fftwf_kdft_register (p, n1_64, &desc);
}
...
static const kdft_desc desc = { 64, "n1_64", {808, 144, 104, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
