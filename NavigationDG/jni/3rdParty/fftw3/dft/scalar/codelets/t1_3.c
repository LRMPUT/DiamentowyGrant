...
static void t1_3(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 3, "t1_3", twinstr, &fftwf_dft_t_genus, {6, 4, 10, 0}, 0, 0, 0 };

void fftwf_codelet_t1_3 (planner *p) {
     fftwf_kdft_dit_register (p, t1_3, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 3, "t1_3", twinstr, &fftwf_dft_t_genus, {10, 6, 6, 0}, 0, 0, 0 };
