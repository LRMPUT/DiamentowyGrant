...
static void hb2_16(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb2_16 (planner *p) {
     fftwf_khc2hc_register (p, hb2_16, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 16, "hb2_16", twinstr, &fftwf_rdft_hb_genus, {156, 68, 40, 0} };
