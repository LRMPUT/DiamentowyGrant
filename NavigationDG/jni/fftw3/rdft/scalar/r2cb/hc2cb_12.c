...
static void hc2cb_12(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 12, "hc2cb_12", twinstr, &fftwf_rdft_hc2cb_genus, {72, 22, 46, 0} };

void fftwf_codelet_hc2cb_12 (planner *p) {
     fftwf_khc2c_register (p, hc2cb_12, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 12, "hc2cb_12", twinstr, &fftwf_rdft_hc2cb_genus, {88, 30, 30, 0} };
