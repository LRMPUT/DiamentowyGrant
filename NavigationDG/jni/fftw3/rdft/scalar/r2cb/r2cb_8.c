...
static const kr2c_desc desc = { 8, "r2cb_8", {8, 0, 12, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_8 (planner *p) {
     fftwf_kr2c_register (p, r2cb_8, &desc);
}
...
static const kr2c_desc desc = { 8, "r2cb_8", {20, 6, 0, 0}, &fftwf_rdft_r2cb_genus };
