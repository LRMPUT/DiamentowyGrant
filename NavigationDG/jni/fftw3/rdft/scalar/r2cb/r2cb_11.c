...
static void r2cb_11(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 11, "r2cb_11", {4, 0, 56, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_11 (planner *p) {
     fftwf_kr2c_register (p, r2cb_11, &desc);
}
...
static const kr2c_desc desc = { 11, "r2cb_11", {19, 10, 41, 0}, &fftwf_rdft_r2cb_genus };
