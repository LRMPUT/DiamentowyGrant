...
static void r2cbIII_4(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 4, "r2cbIII_4", {6, 4, 0, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_4 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_4, &desc);
}
