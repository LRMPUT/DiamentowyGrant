...
static void r2cbIII_9(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 9, "r2cbIII_9", {8, 0, 24, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_9 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_9, &desc);
}
...
static const kr2c_desc desc = { 9, "r2cbIII_9", {22, 8, 10, 0}, &fftwf_rdft_r2cbIII_genus };
