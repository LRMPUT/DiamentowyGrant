...
static void hb_8(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb_8 (planner *p) {
     fftwf_khc2hc_register (p, hb_8, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 8, "hb_8", twinstr, &fftwf_rdft_hb_genus, {52, 18, 14, 0} };
