...
static void r2cbIII_32(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 32, "r2cbIII_32", {106, 32, 68, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_32 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_32, &desc);
}
...
static const kr2c_desc desc = { 32, "r2cbIII_32", {138, 48, 36, 0}, &fftwf_rdft_r2cbIII_genus };
