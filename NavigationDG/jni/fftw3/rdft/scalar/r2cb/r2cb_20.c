...
static void r2cb_20(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 20, "r2cb_20", {42, 0, 44, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_20 (planner *p) {
     fftwf_kr2c_register (p, r2cb_20, &desc);
}
...
static const kr2c_desc desc = { 20, "r2cb_20", {70, 14, 16, 0}, &fftwf_rdft_r2cb_genus };
