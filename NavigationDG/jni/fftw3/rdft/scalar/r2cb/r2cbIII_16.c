...
static void r2cbIII_16(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 16, "r2cbIII_16", {46, 16, 20, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_16 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_16, &desc);
}
...
static const kr2c_desc desc = { 16, "r2cbIII_16", {54, 20, 12, 0}, &fftwf_rdft_r2cbIII_genus };
