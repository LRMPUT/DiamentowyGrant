...
static void hb_3(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb_3 (planner *p) {
     fftwf_khc2hc_register (p, hb_3, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 3, "hb_3", twinstr, &fftwf_rdft_hb_genus, {10, 6, 6, 0} };
