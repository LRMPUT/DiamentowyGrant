...
static void hb_7(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb_7 (planner *p) {
     fftwf_khc2hc_register (p, hb_7, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 7, "hb_7", twinstr, &fftwf_rdft_hb_genus, {36, 24, 36, 0} };
