...
static void r2cbIII_5(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 5, "r2cbIII_5", {2, 0, 10, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_5 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_5, &desc);
}
...
static const kr2c_desc desc = { 5, "r2cbIII_5", {8, 3, 4, 0}, &fftwf_rdft_r2cbIII_genus };
