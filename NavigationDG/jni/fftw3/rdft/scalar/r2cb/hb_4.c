...
static void hb_4(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
void fftwf_codelet_hb_4 (planner *p) {
     fftwf_khc2hc_register (p, hb_4, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 4, "hb_4", twinstr, &fftwf_rdft_hb_genus, {16, 6, 6, 0} };
