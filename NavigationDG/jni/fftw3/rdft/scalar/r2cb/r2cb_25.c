...
static void r2cb_25(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 25, "r2cb_25", {32, 0, 120, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_25 (planner *p) {
     fftwf_kr2c_register (p, r2cb_25, &desc);
}
...
static const kr2c_desc desc = { 25, "r2cb_25", {100, 46, 52, 0}, &fftwf_rdft_r2cb_genus };
