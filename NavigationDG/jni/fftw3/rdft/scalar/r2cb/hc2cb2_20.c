...
static void hc2cb2_20(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 20, "hc2cb2_20", twinstr, &fftwf_rdft_hc2cb_genus, {136, 58, 140, 0} };

void fftwf_codelet_hc2cb2_20 (planner *p) {
     fftwf_khc2c_register (p, hc2cb2_20, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 20, "hc2cb2_20", twinstr, &fftwf_rdft_hc2cb_genus, {204, 92, 72, 0} };
