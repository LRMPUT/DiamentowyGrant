...
static void hb_64(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb_64 (planner *p) {
     fftwf_khc2hc_register (p, hb_64, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 64, "hb_64", twinstr, &fftwf_rdft_hb_genus, {808, 270, 230, 0} };
