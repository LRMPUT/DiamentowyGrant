...
static void hb_25(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 25, "hb_25", twinstr, &fftwf_rdft_hb_genus, {260, 140, 140, 0} };

void fftwf_codelet_hb_25(planner *p) {
     fftwf_khc2hc_register(p, hb_25, &desc);
}
#endif				/* HAVE_FMA */
