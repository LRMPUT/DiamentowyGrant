...
static void hb_20(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 20, "hb_20", twinstr, &fftwf_rdft_hb_genus, {184, 62, 62, 0} };

void fftwf_codelet_hb_20(planner *p) {
     fftwf_khc2hc_register(p, hb_20, &desc);
}
#endif				/* HAVE_FMA */
