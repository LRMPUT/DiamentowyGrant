...
static void e01_8(const float *I, float *O, stride is, stride os, INT v, INT ivs, INT ovs)
{
     DK(KP1_662939224, +1.662939224605090474157576755235811513477121624);
...
static const kr2r_desc desc = { 8, "e01_8", {20, 9, 6, 0}, &fftwf_rdft_r2r_genus, REDFT01 };

void fftwf_codelet_e01_8 (planner *p) {
     fftwf_kr2r_register (p, e01_8, &desc);
}
