...
static void r2cf_128(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 128, "r2cf_128", {440, 0, 516, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_128 (planner *p) {
     fftwf_kr2c_register (p, r2cf_128, &desc);
}
...
static const kr2c_desc desc = { 128, "r2cf_128", {812, 186, 144, 0}, &fftwf_rdft_r2cf_genus };
