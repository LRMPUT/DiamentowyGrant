...
static void hc2cf_8(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 8, "hc2cf_8", twinstr, &fftwf_rdft_hc2cf_genus, {44, 14, 22, 0} };

void fftwf_codelet_hc2cf_8 (planner *p) {
     fftwf_khc2c_register (p, hc2cf_8, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 8, "hc2cf_8", twinstr, &fftwf_rdft_hc2cf_genus, {52, 18, 14, 0} };
