...
static const kr2c_desc desc = { 32, "r2cf_32", {88, 0, 68, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_32 (planner *p) {
     fftwf_kr2c_register (p, r2cf_32, &desc);
}
...
static const kr2c_desc desc = { 32, "r2cf_32", {140, 26, 16, 0}, &fftwf_rdft_r2cf_genus };
