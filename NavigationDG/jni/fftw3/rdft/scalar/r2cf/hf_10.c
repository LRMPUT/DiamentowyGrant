...
static void hf_10(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 10, "hf_10", twinstr, &fftwf_rdft_hf_genus, {48, 18, 54, 0} };

void fftwf_codelet_hf_10 (planner *p) {
     fftwf_khc2hc_register (p, hf_10, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 10, "hf_10", twinstr, &fftwf_rdft_hf_genus, {72, 30, 30, 0} };
