...
static const kr2c_desc desc = { 11, "r2cf_11", {15, 5, 45, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_11 (planner *p) {
     fftwf_kr2c_register (p, r2cf_11, &desc);
}
...
static const kr2c_desc desc = { 11, "r2cf_11", {20, 10, 40, 0}, &fftwf_rdft_r2cf_genus };
