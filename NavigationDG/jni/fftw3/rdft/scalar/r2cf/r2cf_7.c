...
static void r2cf_7(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 7, "r2cf_7", {9, 3, 15, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_7 (planner *p) {
     fftwf_kr2c_register (p, r2cf_7, &desc);
}
...
static const kr2c_desc desc = { 7, "r2cf_7", {12, 6, 12, 0}, &fftwf_rdft_r2cf_genus };
