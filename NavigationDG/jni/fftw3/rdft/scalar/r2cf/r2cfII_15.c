...
static void r2cfII_15(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 15, "r2cfII_15", {38, 7, 34, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_15 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_15, &desc);
}
...
static const kr2c_desc desc = { 15, "r2cfII_15", {54, 15, 18, 0}, &fftwf_rdft_r2cfII_genus };
