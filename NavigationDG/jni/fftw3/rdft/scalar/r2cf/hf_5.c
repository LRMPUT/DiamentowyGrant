...
static void hf_5(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 5, "hf_5", twinstr, &fftwf_rdft_hf_genus, {14, 8, 26, 0} };

void fftwf_codelet_hf_5 (planner *p) {
     fftwf_khc2hc_register (p, hf_5, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 5, "hf_5", twinstr, &fftwf_rdft_hf_genus, {26, 14, 14, 0} };
