...
static void r2cfII_4(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 4, "r2cfII_4", {2, 0, 4, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_4 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_4, &desc);
}
...
static const kr2c_desc desc = { 4, "r2cfII_4", {6, 2, 0, 0}, &fftwf_rdft_r2cfII_genus };
