...
static void r2cfII_8(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 8, "r2cfII_8", {6, 0, 16, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_8 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_8, &desc);
}
...
static const kr2c_desc desc = { 8, "r2cfII_8", {18, 6, 4, 0}, &fftwf_rdft_r2cfII_genus };
