...
static void r2cf_16(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 16, "r2cf_16", {38, 0, 20, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_16 (planner *p) {
     fftwf_kr2c_register (p, r2cf_16, &desc);
}
...
static const kr2c_desc desc = { 16, "r2cf_16", {54, 8, 4, 0}, &fftwf_rdft_r2cf_genus };
