...
static void hf2_25(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 25, "hf2_25", twinstr, &fftwf_rdft_hf_genus, {84, 78, 356, 0} };

void fftwf_codelet_hf2_25 (planner *p) {
     fftwf_khc2hc_register (p, hf2_25, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 25, "hf2_25", twinstr, &fftwf_rdft_hf_genus, {280, 180, 160, 0} };
