...
static void t1_2(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
static const ct_desc desc = { 2, "t1_2", twinstr, &fftwf_dft_t_genus, {4, 2, 2, 0}, 0, 0, 0 };

void fftwf_codelet_t1_2 (planner *p) {
     fftwf_kdft_dit_register (p, t1_2, &desc);
}
#else				/* HAVE_FMA */
