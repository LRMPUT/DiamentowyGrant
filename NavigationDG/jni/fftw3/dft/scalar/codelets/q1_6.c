...
static void q1_6(float *rio, float *iio, const float *W, stride rs, stride vs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 6, "q1_6", twinstr, &fftwf_dft_t_genus, {144, 60, 132, 0}, 0, 0, 0 };

void fftwf_codelet_q1_6 (planner *p) {
     fftwf_kdft_difsq_register (p, q1_6, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 6, "q1_6", twinstr, &fftwf_dft_t_genus, {192, 84, 84, 0}, 0, 0, 0 };
