...
static void t1_15(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 15, "t1_15", twinstr, &fftwf_dft_t_genus, {72, 28, 112, 0}, 0, 0, 0 };

void fftwf_codelet_t1_15 (planner *p) {
     fftwf_kdft_dit_register (p, t1_15, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 15, "t1_15", twinstr, &fftwf_dft_t_genus, {128, 56, 56, 0}, 0, 0, 0 };
