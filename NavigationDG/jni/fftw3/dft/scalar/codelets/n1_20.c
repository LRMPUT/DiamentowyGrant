...
static void n1_20(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 20, "n1_20", {136, 0, 72, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_20 (planner *p) {
     fftwf_kdft_register (p, n1_20, &desc);
}
...
static const kdft_desc desc = { 20, "n1_20", {184, 24, 24, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
