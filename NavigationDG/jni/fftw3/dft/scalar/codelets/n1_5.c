...
static void n1_5(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 5, "n1_5", {14, 0, 18, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_5 (planner *p) {
     fftwf_kdft_register (p, n1_5, &desc);
}
...
static const kdft_desc desc = { 5, "n1_5", {26, 6, 6, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
