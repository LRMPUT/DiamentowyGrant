...
static void n1_12(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 12, "n1_12", {72, 0, 24, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_12 (planner *p) {
     fftwf_kdft_register (p, n1_12, &desc);
}
...
static const kdft_desc desc = { 12, "n1_12", {88, 8, 8, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
