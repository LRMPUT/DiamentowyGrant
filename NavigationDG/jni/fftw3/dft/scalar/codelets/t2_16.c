...
static void t2_16(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 16, "t2_16", twinstr, &fftwf_dft_t_genus, {104, 42, 92, 0}, 0, 0, 0 };

void fftwf_codelet_t2_16 (planner *p) {
     fftwf_kdft_dit_register (p, t2_16, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 16, "t2_16", twinstr, &fftwf_dft_t_genus, {156, 68, 40, 0}, 0, 0, 0 };
