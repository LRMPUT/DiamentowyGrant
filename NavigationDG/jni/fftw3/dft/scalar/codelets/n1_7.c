...
static void n1_7(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 7, "n1_7", {18, 0, 42, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_7 (planner *p) {
     fftwf_kdft_register (p, n1_7, &desc);
}
...
static const kdft_desc desc = { 7, "n1_7", {36, 12, 24, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
