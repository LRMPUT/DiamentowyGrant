...
static void q1_8(float *rio, float *iio, const float *W, stride rs, stride vs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 8, "q1_8", twinstr, &fftwf_dft_t_genus, {352, 112, 176, 0}, 0, 0, 0 };

void fftwf_codelet_q1_8 (planner *p) {
     fftwf_kdft_difsq_register (p, q1_8, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 8, "q1_8", twinstr, &fftwf_dft_t_genus, {416, 144, 112, 0}, 0, 0, 0 };
