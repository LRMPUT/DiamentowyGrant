...
static void n1_14(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 14, "n1_14", {64, 0, 84, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_14(planner *p) {
     fftwf_kdft_register(p, n1_14, &desc);
}
...
static const kdft_desc desc = { 14, "n1_14", {100, 24, 48, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
