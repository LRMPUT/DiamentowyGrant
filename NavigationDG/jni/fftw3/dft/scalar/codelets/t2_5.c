...
static void t2_5(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 5, "t2_5", twinstr, &fftwf_dft_t_genus, {14, 10, 30, 0}, 0, 0, 0 };

void fftwf_codelet_t2_5 (planner *p) {
     fftwf_kdft_dit_register (p, t2_5, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 5, "t2_5", twinstr, &fftwf_dft_t_genus, {30, 18, 14, 0}, 0, 0, 0 };
