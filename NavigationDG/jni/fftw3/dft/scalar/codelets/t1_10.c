...
static void t1_10(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 10, "t1_10", twinstr, &fftwf_dft_t_genus, {48, 18, 54, 0}, 0, 0, 0 };

void fftwf_codelet_t1_10 (planner *p) {
     fftwf_kdft_dit_register (p, t1_10, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 10, "t1_10", twinstr, &fftwf_dft_t_genus, {72, 30, 30, 0}, 0, 0, 0 };
