...
static void t1_20(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 20, "t1_20", twinstr, &fftwf_dft_t_genus, {136, 38, 110, 0}, 0, 0, 0 };

void fftwf_codelet_t1_20 (planner *p) {
     fftwf_kdft_dit_register (p, t1_20, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 20, "t1_20", twinstr, &fftwf_dft_t_genus, {184, 62, 62, 0}, 0, 0, 0 };
