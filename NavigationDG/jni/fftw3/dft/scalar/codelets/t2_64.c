...
static void t2_64(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 64, "t2_64", twinstr, &fftwf_dft_t_genus, {520, 206, 634, 0}, 0, 0, 0 };

void fftwf_codelet_t2_64 (planner *p) {
     fftwf_kdft_dit_register (p, t2_64, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 64, "t2_64", twinstr, &fftwf_dft_t_genus, {880, 386, 274, 0}, 0, 0, 0 };
