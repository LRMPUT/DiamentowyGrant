...
static void n1_16(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 16, "n1_16", {104, 0, 40, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_16 (planner *p) {
     fftwf_kdft_register (p, n1_16, &desc);
}
...
static const kdft_desc desc = { 16, "n1_16", {136, 16, 8, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
