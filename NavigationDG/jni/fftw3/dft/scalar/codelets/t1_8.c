...
static const ct_desc desc = { 8, "t1_8", twinstr, &fftwf_dft_t_genus, {44, 14, 22, 0}, 0, 0, 0 };

void fftwf_codelet_t1_8 (planner *p) {
     fftwf_kdft_dit_register (p, t1_8, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 8, "t1_8", twinstr, &fftwf_dft_t_genus, {52, 18, 14, 0}, 0, 0, 0 };
