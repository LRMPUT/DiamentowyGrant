...
static void n1_6(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 6, "n1_6", {24, 0, 12, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_6 (planner *p) {
     fftwf_kdft_register (p, n1_6, &desc);
}
...
static const kdft_desc desc = { 6, "n1_6", {32, 4, 4, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
