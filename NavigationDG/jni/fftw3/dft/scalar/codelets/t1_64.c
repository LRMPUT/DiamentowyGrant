...
static void t1_64(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 64, "t1_64", twinstr, &fftwf_dft_t_genus, {520, 126, 518, 0}, 0, 0, 0 };

void fftwf_codelet_t1_64 (planner *p) {
     fftwf_kdft_dit_register (p, t1_64, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 64, "t1_64", twinstr, &fftwf_dft_t_genus, {808, 270, 230, 0}, 0, 0, 0 };
