...
static void t1_16(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 16, "t1_16", twinstr, &fftwf_dft_t_genus, {104, 30, 70, 0}, 0, 0, 0 };

void fftwf_codelet_t1_16 (planner *p) {
     fftwf_kdft_dit_register (p, t1_16, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 16, "t1_16", twinstr, &fftwf_dft_t_genus, {136, 46, 38, 0}, 0, 0, 0 };
