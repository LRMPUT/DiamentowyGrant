...
static void t2_32(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 32, "t2_32", twinstr, &fftwf_dft_t_genus, {236, 98, 252, 0}, 0, 0, 0 };

void fftwf_codelet_t2_32 (planner *p) {
     fftwf_kdft_dit_register (p, t2_32, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 32, "t2_32", twinstr, &fftwf_dft_t_genus, {376, 168, 112, 0}, 0, 0, 0 };
