...
static void t1_25(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 25, "t1_25", twinstr, &fftwf_dft_t_genus, {84, 48, 316, 0}, 0, 0, 0 };

void fftwf_codelet_t1_25 (planner *p) {
     fftwf_kdft_dit_register (p, t1_25, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 25, "t1_25", twinstr, &fftwf_dft_t_genus, {260, 140, 140, 0}, 0, 0, 0 };
