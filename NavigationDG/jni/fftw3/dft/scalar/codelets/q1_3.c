...
static const ct_desc desc = { 3, "q1_3", twinstr, &fftwf_dft_t_genus, {18, 12, 30, 0}, 0, 0, 0 };

void fftwf_codelet_q1_3 (planner *p) {
     fftwf_kdft_difsq_register (p, q1_3, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 3, "q1_3", twinstr, &fftwf_dft_t_genus, {30, 18, 18, 0}, 0, 0, 0 };
