...
static void n1_10(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 10, "n1_10", {48, 0, 36, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_10 (planner *p) {
     fftwf_kdft_register (p, n1_10, &desc);
}
...
static const kdft_desc desc = { 10, "n1_10", {72, 12, 12, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
