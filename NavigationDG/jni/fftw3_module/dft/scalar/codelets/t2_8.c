...
static void t2_8(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 8, "t2_8", twinstr, &fftwf_dft_t_genus, {44, 20, 30, 0}, 0, 0, 0 };

void fftwf_codelet_t2_8 (planner *p) {
     fftwf_kdft_dit_register (p, t2_8, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 8, "t2_8", twinstr, &fftwf_dft_t_genus, {56, 26, 18, 0}, 0, 0, 0 };
