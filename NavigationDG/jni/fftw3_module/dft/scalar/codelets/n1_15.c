...
static void n1_15(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 15, "n1_15", {72, 0, 84, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_15 (planner *p) {
     fftwf_kdft_register (p, n1_15, &desc);
}
...
static const kdft_desc desc = { 15, "n1_15", {128, 28, 28, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
