...
static void t1_32(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 32, "t1_32", twinstr, &fftwf_dft_t_genus, {236, 62, 198, 0}, 0, 0, 0 };

void fftwf_codelet_t1_32 (planner *p) {
     fftwf_kdft_dit_register (p, t1_32, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 32, "t1_32", twinstr, &fftwf_dft_t_genus, {340, 114, 94, 0}, 0, 0, 0 };
