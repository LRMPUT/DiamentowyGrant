...
static void n1_8(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 8, "n1_8", {44, 0, 8, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_8 (planner *p) {
     fftwf_kdft_register (p, n1_8, &desc);
}
...
static const kdft_desc desc = { 8, "n1_8", {52, 4, 0, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
