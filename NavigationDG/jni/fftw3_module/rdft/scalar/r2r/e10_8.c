...
static void e10_8(const float *I, float *O, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kr2r_desc desc = { 8, "e10_8", {20, 10, 6, 0}, &fftwf_rdft_r2r_genus, REDFT10 };

void fftwf_codelet_e10_8 (planner *p) {
     fftwf_kr2r_register (p, e10_8, &desc);
}
