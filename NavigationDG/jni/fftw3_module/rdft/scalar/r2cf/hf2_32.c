...
static void hf2_32(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 32, "hf2_32", twinstr, &fftwf_rdft_hf_genus, {236, 98, 252, 0} };

void fftwf_codelet_hf2_32 (planner *p) {
     fftwf_khc2hc_register (p, hf2_32, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 32, "hf2_32", twinstr, &fftwf_rdft_hf_genus, {376, 168, 112, 0} };
