...
static void hc2cfdft_6(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 6, "hc2cfdft_6", twinstr, &fftwf_rdft_hc2cf_genus, {36, 22, 22, 0} };

void fftwf_codelet_hc2cfdft_6 (planner *p) {
     fftwf_khc2c_register (p, hc2cfdft_6, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 6, "hc2cfdft_6", twinstr, &fftwf_rdft_hc2cf_genus, {44, 22, 14, 0} };
