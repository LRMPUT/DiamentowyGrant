...
static void hf_6(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 6, "hf_6", twinstr, &fftwf_rdft_hf_genus, {24, 10, 22, 0} };

void fftwf_codelet_hf_6 (planner *p) {
     fftwf_khc2hc_register (p, hf_6, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 6, "hf_6", twinstr, &fftwf_rdft_hf_genus, {32, 14, 14, 0} };
