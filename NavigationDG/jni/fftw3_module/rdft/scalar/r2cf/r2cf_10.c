...
static void r2cf_10(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 10, "r2cf_10", {24, 4, 10, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_10 (planner *p) {
     fftwf_kr2c_register (p, r2cf_10, &desc);
}
...
static const kr2c_desc desc = { 10, "r2cf_10", {28, 6, 6, 0}, &fftwf_rdft_r2cf_genus };
