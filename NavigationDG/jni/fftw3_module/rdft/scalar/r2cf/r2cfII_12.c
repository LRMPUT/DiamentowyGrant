...
static void r2cfII_12(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 12, "r2cfII_12", {21, 0, 24, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_12 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_12, &desc);
}
...
static const kr2c_desc desc = { 12, "r2cfII_12", {39, 8, 4, 0}, &fftwf_rdft_r2cfII_genus };
