...
static void hf_16(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 16, "hf_16", twinstr, &fftwf_rdft_hf_genus, {104, 30, 70, 0} };

void fftwf_codelet_hf_16 (planner *p) {
     fftwf_khc2hc_register (p, hf_16, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 16, "hf_16", twinstr, &fftwf_rdft_hf_genus, {136, 46, 38, 0} };
