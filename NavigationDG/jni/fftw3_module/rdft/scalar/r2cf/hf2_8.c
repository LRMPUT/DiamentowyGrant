...
static void hf2_8(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 8, "hf2_8", twinstr, &fftwf_rdft_hf_genus, {44, 20, 30, 0} };

void fftwf_codelet_hf2_8 (planner *p) {
     fftwf_khc2hc_register (p, hf2_8, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 8, "hf2_8", twinstr, &fftwf_rdft_hf_genus, {56, 26, 18, 0} };
