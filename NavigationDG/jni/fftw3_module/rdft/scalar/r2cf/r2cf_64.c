...
static void r2cf_64(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 64, "r2cf_64", {198, 0, 196, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_64 (planner *p) {
     fftwf_kr2c_register (p, r2cf_64, &desc);
}
...
static const kr2c_desc desc = { 64, "r2cf_64", {342, 72, 52, 0}, &fftwf_rdft_r2cf_genus };
