...
static void r2cf_5(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 5, "r2cf_5", {7, 2, 5, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_5 (planner *p) {
     fftwf_kr2c_register (p, r2cf_5, &desc);
}
...
static const kr2c_desc desc = { 5, "r2cf_5", {9, 3, 3, 0}, &fftwf_rdft_r2cf_genus };
