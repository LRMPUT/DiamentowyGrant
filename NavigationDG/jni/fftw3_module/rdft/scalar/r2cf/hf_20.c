...
static void hf_20(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 20, "hf_20", twinstr, &fftwf_rdft_hf_genus, {136, 38, 110, 0} };

void fftwf_codelet_hf_20 (planner *p) {
     fftwf_khc2hc_register (p, hf_20, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 20, "hf_20", twinstr, &fftwf_rdft_hf_genus, {184, 62, 62, 0} };
