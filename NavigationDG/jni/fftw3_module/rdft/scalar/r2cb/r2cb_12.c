...
static void r2cb_12(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 12, "r2cb_12", {22, 0, 16, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_12 (planner *p) {
     fftwf_kr2c_register (p, r2cb_12, &desc);
}
...
static const kr2c_desc desc = { 12, "r2cb_12", {34, 6, 4, 0}, &fftwf_rdft_r2cb_genus };
