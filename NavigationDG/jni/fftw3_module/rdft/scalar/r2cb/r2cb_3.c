...
static void r2cb_3(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 3, "r2cb_3", {1, 0, 3, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_3 (planner *p) {
     fftwf_kr2c_register (p, r2cb_3, &desc);
}
...
static const kr2c_desc desc = { 3, "r2cb_3", {3, 1, 1, 0}, &fftwf_rdft_r2cb_genus };
