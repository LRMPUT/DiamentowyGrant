...
static void hb2_20(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb2_20 (planner *p) {
     fftwf_khc2hc_register (p, hb2_20, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 20, "hb2_20", twinstr, &fftwf_rdft_hb_genus, {204, 92, 72, 0} };
