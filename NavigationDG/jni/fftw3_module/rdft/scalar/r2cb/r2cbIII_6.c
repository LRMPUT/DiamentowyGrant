...
static void r2cbIII_6(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 6, "r2cbIII_6", {6, 2, 6, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_6 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_6, &desc);
}
...
static const kr2c_desc desc = { 6, "r2cbIII_6", {10, 4, 2, 0}, &fftwf_rdft_r2cbIII_genus };
