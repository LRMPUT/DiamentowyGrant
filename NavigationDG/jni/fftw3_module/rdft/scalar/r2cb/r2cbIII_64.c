...
static void r2cbIII_64(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 64, "r2cbIII_64", {238, 64, 196, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_64 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_64, &desc);
}
...
static const kr2c_desc desc = { 64, "r2cbIII_64", {342, 116, 92, 0}, &fftwf_rdft_r2cbIII_genus };
