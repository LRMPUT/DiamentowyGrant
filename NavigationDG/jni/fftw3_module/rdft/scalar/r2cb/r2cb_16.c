...
static void r2cb_16(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 16, "r2cb_16", {26, 0, 32, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_16 (planner *p) {
     fftwf_kr2c_register (p, r2cb_16, &desc);
}
...
static const kr2c_desc desc = { 16, "r2cb_16", {54, 14, 4, 0}, &fftwf_rdft_r2cb_genus };
