...
static void r2cbIII_12(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 12, "r2cbIII_12", {30, 8, 12, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_12 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_12, &desc);
}
...
static const kr2c_desc desc = { 12, "r2cbIII_12", {38, 16, 4, 0}, &fftwf_rdft_r2cbIII_genus };
