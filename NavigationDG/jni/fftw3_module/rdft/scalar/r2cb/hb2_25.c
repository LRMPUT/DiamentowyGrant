...
static void hb2_25(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb2_25 (planner *p) {
     fftwf_khc2hc_register (p, hb2_25, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 25, "hb2_25", twinstr, &fftwf_rdft_hb_genus, {280, 180, 160, 0} };
