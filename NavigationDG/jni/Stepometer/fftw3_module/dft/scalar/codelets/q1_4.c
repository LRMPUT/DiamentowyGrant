...
static void q1_4(float *rio, float *iio, const float *W, stride rs, stride vs, INT mb, INT me, INT ms)
{
     INT m;
...
static const ct_desc desc = { 4, "q1_4", twinstr, &fftwf_dft_t_genus, {64, 24, 24, 0}, 0, 0, 0 };

void fftwf_codelet_q1_4 (planner *p) {
     fftwf_kdft_difsq_register (p, q1_4, &desc);
}
#else				/* HAVE_FMA */
