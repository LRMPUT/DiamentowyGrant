...
static void n1_3(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 3, "n1_3", {6, 0, 6, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_3 (planner *p) {
     fftwf_kdft_register (p, n1_3, &desc);
}
...
static const kdft_desc desc = { 3, "n1_3", {10, 2, 2, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
