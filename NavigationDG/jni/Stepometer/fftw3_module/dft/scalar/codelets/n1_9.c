...
static void n1_9(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 9, "n1_9", {24, 0, 56, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_9 (planner *p) {
     fftwf_kdft_register (p, n1_9, &desc);
}
...
static const kdft_desc desc = { 9, "n1_9", {60, 20, 20, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
