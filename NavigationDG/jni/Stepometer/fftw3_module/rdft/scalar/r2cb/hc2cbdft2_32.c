...
static void hc2cbdft2_32(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 32, "hc2cbdft2_32", twinstr, &fftwf_rdft_hc2cb_genus, {300, 62, 198, 0} };

void fftwf_codelet_hc2cbdft2_32 (planner *p) {
     fftwf_khc2c_register (p, hc2cbdft2_32, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 32, "hc2cbdft2_32", twinstr, &fftwf_rdft_hc2cb_genus, {404, 114, 94, 0} };
