...
static void hb2_32(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb2_32 (planner *p) {
     fftwf_khc2hc_register (p, hb2_32, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 32, "hb2_32", twinstr, &fftwf_rdft_hb_genus, {376, 168, 112, 0} };
