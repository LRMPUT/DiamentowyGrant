...
static void hc2cb_4(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
static const hc2c_desc desc = { 4, "hc2cb_4", twinstr, &fftwf_rdft_hc2cb_genus, {16, 6, 6, 0} };

void fftwf_codelet_hc2cb_4 (planner *p) {
     fftwf_khc2c_register (p, hc2cb_4, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
