...
static void hb_15(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 15, "hb_15", twinstr, &fftwf_rdft_hb_genus, {128, 56, 56, 0} };

void fftwf_codelet_hb_15(planner *p) {
     fftwf_khc2hc_register(p, hb_15, &desc);
}
#endif				/* HAVE_FMA */
