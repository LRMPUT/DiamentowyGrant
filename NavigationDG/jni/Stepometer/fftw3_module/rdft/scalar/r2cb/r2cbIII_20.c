...
static const kr2c_desc desc = { 20, "r2cbIII_20", {58, 20, 36, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_20 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_20, &desc);
}
...
static const kr2c_desc desc = { 20, "r2cbIII_20", {82, 32, 12, 0}, &fftwf_rdft_r2cbIII_genus };
