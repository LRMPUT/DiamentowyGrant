...
static void hc2cb2_32(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 32, "hc2cb2_32", twinstr, &fftwf_rdft_hc2cb_genus, {236, 98, 252, 0} };

void fftwf_codelet_hc2cb2_32 (planner *p) {
     fftwf_khc2c_register (p, hc2cb2_32, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 32, "hc2cb2_32", twinstr, &fftwf_rdft_hc2cb_genus, {376, 168, 112, 0} };
