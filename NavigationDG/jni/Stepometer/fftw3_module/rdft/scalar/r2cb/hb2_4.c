...
static void hb2_4(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
void fftwf_codelet_hb2_4 (planner *p) {
     fftwf_khc2hc_register (p, hb2_4, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 4, "hb2_4", twinstr, &fftwf_rdft_hb_genus, {16, 8, 8, 0} };
