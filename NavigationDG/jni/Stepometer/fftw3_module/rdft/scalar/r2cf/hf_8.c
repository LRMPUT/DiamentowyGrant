...
static void hf_8(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 8, "hf_8", twinstr, &fftwf_rdft_hf_genus, {44, 14, 22, 0} };

void fftwf_codelet_hf_8 (planner *p) {
     fftwf_khc2hc_register (p, hf_8, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 8, "hf_8", twinstr, &fftwf_rdft_hf_genus, {52, 18, 14, 0} };
