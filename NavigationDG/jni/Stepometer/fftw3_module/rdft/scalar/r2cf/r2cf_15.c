...
static void r2cf_15(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 15, "r2cf_15", {36, 7, 28, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_15 (planner *p) {
     fftwf_kr2c_register (p, r2cf_15, &desc);
}
...
static const kr2c_desc desc = { 15, "r2cf_15", {50, 11, 14, 0}, &fftwf_rdft_r2cf_genus };
