...
static void hf2_5(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 5, "hf2_5", twinstr, &fftwf_rdft_hf_genus, {14, 10, 30, 0} };

void fftwf_codelet_hf2_5 (planner *p) {
     fftwf_khc2hc_register (p, hf2_5, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 5, "hf2_5", twinstr, &fftwf_rdft_hf_genus, {30, 18, 14, 0} };
