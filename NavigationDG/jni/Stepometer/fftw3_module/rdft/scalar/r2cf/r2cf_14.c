...
static void r2cf_14(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 14, "r2cf_14", {32, 6, 30, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_14 (planner *p) {
     fftwf_kr2c_register (p, r2cf_14, &desc);
}
...
static const kr2c_desc desc = { 14, "r2cf_14", {38, 12, 24, 0}, &fftwf_rdft_r2cf_genus };
