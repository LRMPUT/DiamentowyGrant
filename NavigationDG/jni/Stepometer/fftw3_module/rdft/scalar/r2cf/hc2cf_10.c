...
static void hc2cf_10(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 10, "hc2cf_10", twinstr, &fftwf_rdft_hc2cf_genus, {48, 18, 54, 0} };

void fftwf_codelet_hc2cf_10 (planner *p) {
     fftwf_khc2c_register (p, hc2cf_10, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 10, "hc2cf_10", twinstr, &fftwf_rdft_hc2cf_genus, {72, 30, 30, 0} };
