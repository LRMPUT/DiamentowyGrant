...
static void hc2cfdft_16(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 16, "hc2cfdft_16", twinstr, &fftwf_rdft_hc2cf_genus, {136, 62, 70, 0} };

void fftwf_codelet_hc2cfdft_16 (planner *p) {
     fftwf_khc2c_register (p, hc2cfdft_16, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 16, "hc2cfdft_16", twinstr, &fftwf_rdft_hc2cf_genus, {168, 62, 38, 0} };
