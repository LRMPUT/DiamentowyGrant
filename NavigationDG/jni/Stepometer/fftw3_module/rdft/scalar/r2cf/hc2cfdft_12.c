...
static void hc2cfdft_12(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 12, "hc2cfdft_12", twinstr, &fftwf_rdft_hc2cf_genus, {96, 46, 46, 0} };

void fftwf_codelet_hc2cfdft_12 (planner *p) {
     fftwf_khc2c_register (p, hc2cfdft_12, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 12, "hc2cfdft_12", twinstr, &fftwf_rdft_hc2cf_genus, {112, 46, 30, 0} };
