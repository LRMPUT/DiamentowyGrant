...
static void hf_2(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
static const hc2hc_desc desc = { 2, "hf_2", twinstr, &fftwf_rdft_hf_genus, {4, 2, 2, 0} };

void fftwf_codelet_hf_2 (planner *p) {
     fftwf_khc2hc_register (p, hf_2, &desc);
}
#else				/* HAVE_FMA */
