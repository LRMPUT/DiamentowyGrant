...
static void hf_15(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 15, "hf_15", twinstr, &fftwf_rdft_hf_genus, {72, 28, 112, 0} };

void fftwf_codelet_hf_15 (planner *p) {
     fftwf_khc2hc_register (p, hf_15, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 15, "hf_15", twinstr, &fftwf_rdft_hf_genus, {128, 56, 56, 0} };
