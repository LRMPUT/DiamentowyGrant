...
static void r2cfII_9(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 9, "r2cfII_9", {12, 4, 30, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_9 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_9, &desc);
}
...
static const kr2c_desc desc = { 9, "r2cfII_9", {25, 13, 17, 0}, &fftwf_rdft_r2cfII_genus };
