...
static void hf_12(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 12, "hf_12", twinstr, &fftwf_rdft_hf_genus, {72, 22, 46, 0} };

void fftwf_codelet_hf_12 (planner *p) {
     fftwf_khc2hc_register (p, hf_12, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 12, "hf_12", twinstr, &fftwf_rdft_hf_genus, {88, 30, 30, 0} };
