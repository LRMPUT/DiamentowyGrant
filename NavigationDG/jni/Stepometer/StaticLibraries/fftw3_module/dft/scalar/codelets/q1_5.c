...
static void q1_5(float *rio, float *iio, const float *W, stride rs, stride vs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 5, "q1_5", twinstr, &fftwf_dft_t_genus, {70, 40, 130, 0}, 0, 0, 0 };

void fftwf_codelet_q1_5 (planner *p) {
     fftwf_kdft_difsq_register (p, q1_5, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 5, "q1_5", twinstr, &fftwf_dft_t_genus, {130, 70, 70, 0}, 0, 0, 0 };
