...
static void t2_25(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 25, "t2_25", twinstr, &fftwf_dft_t_genus, {84, 78, 356, 0}, 0, 0, 0 };

void fftwf_codelet_t2_25 (planner *p) {
     fftwf_kdft_dit_register (p, t2_25, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 25, "t2_25", twinstr, &fftwf_dft_t_genus, {280, 180, 160, 0}, 0, 0, 0 };
