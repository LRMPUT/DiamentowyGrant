...
static void n1_32(const float *ri, const float *ii, float *ro, float *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
static const kdft_desc desc = { 32, "n1_32", {236, 0, 136, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_32(planner *p) {
     fftwf_kdft_register(p, n1_32, &desc);
}
...
static const kdft_desc desc = { 32, "n1_32", {340, 52, 32, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
