...
static const kdft_desc desc = { 11, "n1_11", {30, 0, 110, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };

void fftwf_codelet_n1_11 (planner *p) {
     fftwf_kdft_register (p, n1_11, &desc);
}
...
static const kdft_desc desc = { 11, "n1_11", {60, 20, 80, 0}, &fftwf_dft_n_genus, 0, 0, 0, 0 };
