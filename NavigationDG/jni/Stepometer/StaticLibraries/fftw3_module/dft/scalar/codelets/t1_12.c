...
static void t1_12(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 12, "t1_12", twinstr, &fftwf_dft_t_genus, {72, 22, 46, 0}, 0, 0, 0 };

void fftwf_codelet_t1_12 (planner *p) {
     fftwf_kdft_dit_register (p, t1_12, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 12, "t1_12", twinstr, &fftwf_dft_t_genus, {88, 30, 30, 0}, 0, 0, 0 };
