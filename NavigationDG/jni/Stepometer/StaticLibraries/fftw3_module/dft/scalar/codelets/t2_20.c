...
static void t2_20(float *ri, float *ii, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 20, "t2_20", twinstr, &fftwf_dft_t_genus, {136, 58, 140, 0}, 0, 0, 0 };

void fftwf_codelet_t2_20 (planner *p) {
     fftwf_kdft_dit_register (p, t2_20, &desc);
}
#else				/* HAVE_FMA */
...
static const ct_desc desc = { 20, "t2_20", twinstr, &fftwf_dft_t_genus, {204, 92, 72, 0}, 0, 0, 0 };
