...
static void hc2cb2_16(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 16, "hc2cb2_16", twinstr, &fftwf_rdft_hc2cb_genus, {104, 42, 92, 0} };

void fftwf_codelet_hc2cb2_16 (planner *p) {
     fftwf_khc2c_register (p, hc2cb2_16, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 16, "hc2cb2_16", twinstr, &fftwf_rdft_hc2cb_genus, {156, 68, 40, 0} };
