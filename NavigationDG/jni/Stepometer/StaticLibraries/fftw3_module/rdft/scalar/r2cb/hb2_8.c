...
static void hb2_8(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb2_8 (planner *p) {
     fftwf_khc2hc_register (p, hb2_8, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 8, "hb2_8", twinstr, &fftwf_rdft_hb_genus, {56, 26, 18, 0} };
