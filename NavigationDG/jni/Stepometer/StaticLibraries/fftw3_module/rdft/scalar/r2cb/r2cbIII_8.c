...
static void r2cbIII_8(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 8, "r2cbIII_8", {18, 8, 4, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_8 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_8, &desc);
}
