...
static void hc2cb2_8(float *Rp, float *Ip, float *Rm, float *Im, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2c_desc desc = { 8, "hc2cb2_8", twinstr, &fftwf_rdft_hc2cb_genus, {44, 20, 30, 0} };

void fftwf_codelet_hc2cb2_8 (planner *p) {
     fftwf_khc2c_register (p, hc2cb2_8, &desc, HC2C_VIA_RDFT);
}
#else				/* HAVE_FMA */
...
static const hc2c_desc desc = { 8, "hc2cb2_8", twinstr, &fftwf_rdft_hc2cb_genus, {56, 26, 18, 0} };
