...
static const kr2c_desc desc = { 13, "r2cb_13", {18, 0, 58, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_13 (planner *p) {
     fftwf_kr2c_register (p, r2cb_13, &desc);
}
...
static const kr2c_desc desc = { 13, "r2cb_13", {56, 15, 20, 0}, &fftwf_rdft_r2cb_genus };
