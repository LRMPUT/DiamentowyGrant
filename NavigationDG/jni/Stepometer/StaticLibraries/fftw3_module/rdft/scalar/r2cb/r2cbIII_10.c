...
static void r2cbIII_10(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 10, "r2cbIII_10", {14, 10, 18, 0}, &fftwf_rdft_r2cbIII_genus };

void fftwf_codelet_r2cbIII_10 (planner *p) {
     fftwf_kr2c_register (p, r2cbIII_10, &desc);
}
...
static const kr2c_desc desc = { 10, "r2cbIII_10", {26, 10, 6, 0}, &fftwf_rdft_r2cbIII_genus };
