...
static void r2cb_128(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 128, "r2cb_128", {416, 0, 540, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_128 (planner *p) {
     fftwf_kr2c_register (p, r2cb_128, &desc);
}
...
static const kr2c_desc desc = { 128, "r2cb_128", {812, 198, 144, 0}, &fftwf_rdft_r2cb_genus };
