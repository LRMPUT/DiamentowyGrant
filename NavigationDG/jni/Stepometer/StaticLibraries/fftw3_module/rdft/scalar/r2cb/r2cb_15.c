...
static void r2cb_15(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 15, "r2cb_15", {21, 0, 43, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_15 (planner *p) {
     fftwf_kr2c_register (p, r2cb_15, &desc);
}
...
static const kr2c_desc desc = { 15, "r2cb_15", {47, 14, 17, 0}, &fftwf_rdft_r2cb_genus };
