...
static void hb_10(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb_10 (planner *p) {
     fftwf_khc2hc_register (p, hb_10, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 10, "hb_10", twinstr, &fftwf_rdft_hb_genus, {72, 30, 30, 0} };
