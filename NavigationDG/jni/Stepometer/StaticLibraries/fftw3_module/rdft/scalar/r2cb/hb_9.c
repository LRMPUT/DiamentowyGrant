...
static void hb_9(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb_9 (planner *p) {
     fftwf_khc2hc_register (p, hb_9, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 9, "hb_9", twinstr, &fftwf_rdft_hb_genus, {60, 36, 36, 0} };
