...
static void hb_32(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 32, "hb_32", twinstr, &fftwf_rdft_hb_genus, {340, 114, 94, 0} };

void fftwf_codelet_hb_32(planner *p) {
     fftwf_khc2hc_register(p, hb_32, &desc);
}
#endif				/* HAVE_FMA */
