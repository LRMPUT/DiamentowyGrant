...
static void r2cb_64(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 64, "r2cb_64", {178, 0, 216, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_64 (planner *p) {
     fftwf_kr2c_register (p, r2cb_64, &desc);
}
...
static const kr2c_desc desc = { 64, "r2cb_64", {342, 82, 52, 0}, &fftwf_rdft_r2cb_genus };
