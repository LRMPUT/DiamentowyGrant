...
static void hb_5(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftwf_codelet_hb_5 (planner *p) {
     fftwf_khc2hc_register (p, hb_5, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 5, "hb_5", twinstr, &fftwf_rdft_hb_genus, {26, 14, 14, 0} };
