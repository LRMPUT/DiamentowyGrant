...
static void r2cb_7(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 7, "r2cb_7", {2, 0, 22, 0}, &fftwf_rdft_r2cb_genus };

void fftwf_codelet_r2cb_7 (planner *p) {
     fftwf_kr2c_register (p, r2cb_7, &desc);
}
...
static const kr2c_desc desc = { 7, "r2cb_7", {11, 6, 13, 0}, &fftwf_rdft_r2cb_genus };
