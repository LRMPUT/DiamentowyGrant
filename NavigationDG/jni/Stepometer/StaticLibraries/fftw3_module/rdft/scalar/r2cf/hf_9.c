...
static void hf_9(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 9, "hf_9", twinstr, &fftwf_rdft_hf_genus, {24, 16, 72, 0} };

void fftwf_codelet_hf_9 (planner *p) {
     fftwf_khc2hc_register (p, hf_9, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 9, "hf_9", twinstr, &fftwf_rdft_hf_genus, {60, 36, 36, 0} };
