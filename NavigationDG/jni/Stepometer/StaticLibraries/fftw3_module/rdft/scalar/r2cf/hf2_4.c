...
static void hf2_4(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
     INT m;
...
static const hc2hc_desc desc = { 4, "hf2_4", twinstr, &fftwf_rdft_hf_genus, {16, 8, 8, 0} };

void fftwf_codelet_hf2_4 (planner *p) {
     fftwf_khc2hc_register (p, hf2_4, &desc);
}
#else				/* HAVE_FMA */
