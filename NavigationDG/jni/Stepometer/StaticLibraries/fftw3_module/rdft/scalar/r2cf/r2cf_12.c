...
static void r2cf_12(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 12, "r2cf_12", {30, 2, 8, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_12 (planner *p) {
     fftwf_kr2c_register (p, r2cf_12, &desc);
}
...
static const kr2c_desc desc = { 12, "r2cf_12", {34, 4, 4, 0}, &fftwf_rdft_r2cf_genus };
