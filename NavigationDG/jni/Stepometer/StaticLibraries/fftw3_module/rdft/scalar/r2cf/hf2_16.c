...
static void hf2_16(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 16, "hf2_16", twinstr, &fftwf_rdft_hf_genus, {104, 42, 92, 0} };

void fftwf_codelet_hf2_16 (planner *p) {
     fftwf_khc2hc_register (p, hf2_16, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 16, "hf2_16", twinstr, &fftwf_rdft_hf_genus, {156, 68, 40, 0} };
