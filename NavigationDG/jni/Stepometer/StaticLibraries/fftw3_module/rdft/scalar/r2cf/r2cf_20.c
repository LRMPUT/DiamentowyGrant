...
static void r2cf_20(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 20, "r2cf_20", {58, 4, 28, 0}, &fftwf_rdft_r2cf_genus };

void fftwf_codelet_r2cf_20 (planner *p) {
     fftwf_kr2c_register (p, r2cf_20, &desc);
}
...
static const kr2c_desc desc = { 20, "r2cf_20", {74, 12, 12, 0}, &fftwf_rdft_r2cf_genus };
