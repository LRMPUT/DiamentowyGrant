...
static void r2cfII_16(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 16, "r2cfII_16", {18, 0, 48, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_16 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_16, &desc);
}
...
static const kr2c_desc desc = { 16, "r2cfII_16", {54, 18, 12, 0}, &fftwf_rdft_r2cfII_genus };
