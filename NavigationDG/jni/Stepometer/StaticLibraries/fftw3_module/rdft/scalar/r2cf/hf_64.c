...
static void hf_64(float *cr, float *ci, const float *W, stride rs, INT mb, INT me, INT ms)
{
...
static const hc2hc_desc desc = { 64, "hf_64", twinstr, &fftwf_rdft_hf_genus, {520, 126, 518, 0} };

void fftwf_codelet_hf_64 (planner *p) {
     fftwf_khc2hc_register (p, hf_64, &desc);
}
#else				/* HAVE_FMA */
...
static const hc2hc_desc desc = { 64, "hf_64", twinstr, &fftwf_rdft_hf_genus, {808, 270, 230, 0} };
