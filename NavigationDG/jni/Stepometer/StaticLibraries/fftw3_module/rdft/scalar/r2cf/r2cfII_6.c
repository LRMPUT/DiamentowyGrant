...
static void r2cfII_6(float *R0, float *R1, float *Cr, float *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
static const kr2c_desc desc = { 6, "r2cfII_6", {7, 0, 6, 0}, &fftwf_rdft_r2cfII_genus };

void fftwf_codelet_r2cfII_6 (planner *p) {
     fftwf_kr2c_register (p, r2cfII_6, &desc);
}
...
static const kr2c_desc desc = { 6, "r2cfII_6", {11, 2, 2, 0}, &fftwf_rdft_r2cfII_genus };
